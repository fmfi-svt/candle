...
<ul id="rozvrh_akcie">
    <li><?php
        if($published_slug) {
            ...
            echo '</li><li>';
            echo link_to('Nepublikovať', '@timetable_unpublish?id='.$timetable_id, array('rel' => 'nofollow'));
        }
        else {
            echo link_to('Publikovať', '@timetable_publish?id='.$timetable_id, array('rel' => 'nofollow'));
        }
        ?></li><!--
    ...
    --><li><?php echo link_to('Duplikovať', '@timetable_duplicate?id='.$timetable_id, array('rel' => 'nofollow')); ?></li><!--
