...
CREATE TABLE subject (id BIGINT AUTO_INCREMENT, name VARCHAR(100) NOT NULL, code VARCHAR(30) NOT NULL, short_code VARCHAR(10) NOT NULL, creditvalue BIGINT NOT NULL, rozsah VARCHAR(30) NOT NULL, external_id VARCHAR(30), PRIMARY KEY(id)) ENGINE = INNODB;
