...
CREATE TABLE subject (id BIGINT AUTO_INCREMENT, name VARCHAR(50) NOT NULL, code VARCHAR(30) NOT NULL, short_code VARCHAR(10) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
