...
CREATE TABLE subject (id BIGINT AUTO_INCREMENT, name VARCHAR(100) NOT NULL, code VARCHAR(50) NOT NULL, short_code VARCHAR(20) NOT NULL, credit_value BIGINT NOT NULL, rozsah VARCHAR(30), external_id VARCHAR(30), UNIQUE INDEX external_id_index_idx (external_id), PRIMARY KEY(id)) ENGINE = INNODB;
