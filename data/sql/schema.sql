...
CREATE TABLE teacher (id BIGINT AUTO_INCREMENT, given_name VARCHAR(50), family_name VARCHAR(50) NOT NULL, iniciala VARCHAR(50), oddelenie VARCHAR(50), katedra VARCHAR(50), external_id VARCHAR(30), login VARCHAR(50), UNIQUE INDEX login_index_idx (login), PRIMARY KEY(id)) ENGINE = INNODB;
